...
// (in-package grid_map_header.msg)
...
class GridMapWithHeader {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GridMapWithHeader(null);
  ...
  static datatype() {
    ...
    return 'grid_map_header/GridMapWithHeader';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '760be3d6235180b2ae5422ca62c88f03';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GridMapWithHeader(null);
...
module.exports = GridMapWithHeader;
